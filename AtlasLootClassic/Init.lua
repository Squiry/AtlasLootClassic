...
local WOW_PROJECT_CATA_CLASSIC = _G.WOW_PROJECT_CATACLYSM_CLASSIC or 14
...
AtlasLoot.GAME_VERSION_TEXTURES = {
	...
	[AtlasLoot.CATA_VERSION_NUM] = 235509,
}
...
elseif WOW_PROJECT_ID == WOW_PROJECT_WRATH_CLASSIC then
	CurrentGameVersion = AtlasLoot.WRATH_VERSION_NUM
	AtlasLoot.IS_WRATH = true
elseif WOW_PROJECT_ID == WOW_PROJECT_CATA_CLASSIC then
